...
abstract class SharedPreference(context: Context, preferences: SharedPreferences? = null) {
    private val pref = preferences ?: context.getSharedPreferences("My_pref", Context.MODE_PRIVATE)
    protected val gson: Gson = GsonBuilder().create()

    inner class Objects<T>(private val clazz: Class<T>, private val init: T? = null) : ReadWriteProperty<Any, T?> {
